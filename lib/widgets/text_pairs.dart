...
class TextPairs {
  Widget type1({required String title, required String description}) {
    return Column(
      ...
      children: [
        Row(
          children: [
            SelectableText(title, style: AppThemeData.darkTheme.textTheme.titleMedium),
          ],
        ),
  ...
  Widget type3({required String title, required String value1, required String value2}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SelectableText(
