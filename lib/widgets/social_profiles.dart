  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        ButtonIcon(name: 'hashnode', url: DataValues.hashnodeURL).returnButton(),
        const SizedBox(width: 10.0),
        ButtonIcon(name: 'github', url: DataValues.githubURL).returnButton(),
        const SizedBox(width: 10.0),
        ButtonIcon(name: 'gitlab', url: DataValues.gitlabURL).returnButton(),
        const SizedBox(width: 10.0),
        ButtonIcon(name: 'linkedin', url: DataValues.linkedinURL).returnButton(),
        const SizedBox(width: 10.0),
        ...
        // const SizedBox(width: 10.0),
        ButtonIcon(name: 'telegram', url: DataValues.telegramURL).returnButton(),
        const SizedBox(width: 10.0),
        ButtonIcon(name: 'facebook', url: DataValues.facebookURL).returnButton(),
        const SizedBox(width: 10.0),
